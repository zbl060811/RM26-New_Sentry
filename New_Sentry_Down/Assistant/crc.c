...
const uint8_t CRC8_INIT = 0xff;  // CRC8初始值
...
/**
 * @brief  添加CRC8校验值到数据末尾
 * @param  pchMessage: 数据指针
 * @param  dwLength: 数据长度（包含CRC8字节位置）
 */
...
const uint16_t CRC16_INIT = 0xffff;  // CRC16初始值
 ...
 * @brief  验证CRC16校验值
 * @param  pchMessage: 数据指针
 * @param  dwLength: 数据长度（包含CRC16的2字节）
 * @return 1: 校验通过, 0: 校验失败
 */
...
/**
 * @brief  添加CRC16校验值到数据末尾
 * @param  pchMessage: 数据指针
 * @param  dwLength: 数据长度（包含CRC16的2字节位置）
 */
